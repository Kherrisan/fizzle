...
use crate::{
    ...
    state::{FizzleSingleton, FizzleState},
};

pub use private::EventfdId;

use super::{
    descriptor::{DescriptorError, DescriptorId, DescriptorInfo, FdResource},
    init_from_slice,
    polled::{PolledId, PolledInfo},
    FfiOutput, MsgHdr, MsgHdrOut,
};
